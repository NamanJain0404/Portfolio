...
function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-slate-950/90 backdrop-blur-lg border-b border-slate-800 z-50">
      ...
      {menuOpen && (
        <div className="md:hidden bg-slate-900 px-6 py-4 space-y-4 text-white">
